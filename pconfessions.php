...
?>
		...
		<form action="" method="">
			<div id="div1">
				<textarea name="content" style="height: 122px; width: 460px" id="text1"></textarea><br /><br />
				<button type="button" style="height: 30px; width: 60px;"> Submit </button>
			</div>
			<div hidden id="div2">
				<p>Submitted!</p>
			</div>
		...
		<?php 
			$con=mysqli_connect("localhost","root","boolaboolabitch","confessions");
			if (!$con) {
